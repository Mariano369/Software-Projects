...
import { ArrowLeft, Call, Email, Home, LocationOn, Schedule, WhatsApp } from '@mui/icons-material'
        ...
        <div data-title="div" id="principal" className={theme.header}>
          <Container className={theme.contenedorCertificados}>
            <div data-title="div" className={theme.divTituloCertificados}>
              ...
              <Typography variant="h1">Contacto Información</Typography>
            </div>
          </Container>

          <div data-title="div" className={theme.mapa}>
            <LeafLetMap position={[-31.345575, -65.191234]} zoom={30} scroll={true}>
              <Marker position={[-31.345575, -65.191234]}></Marker>
            </LeafLetMap>
          </div>

          <Container className={theme.contenedorContenidoCertificados}>
            <div data-title="div" className={theme.divContenidoCertificados}>
              <Typography variant="h2">Dirección postal y ubicación de la agencia</Typography>

              <Typography variant="h3">Escribanía Lorem Ipsum</Typography>

              <Typography variant="h3">150 Av. Lorem Ipsum</Typography>

              <Typography variant="h3">Villa Dolores, CP 5870</Typography>

              <Typography variant="h3">
                El horario de atención es de lunes a viernes, de 9:00 a.m. a 18:00 p.m., excepto los días festivos estatales.
              </Typography>
            </div>
          </Container>
