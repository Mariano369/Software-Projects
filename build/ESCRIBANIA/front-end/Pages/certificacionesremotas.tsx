...
import { ArrowBackIos, ArrowCircleRightOutlined, Brightness1, Call, Email, Home, LocationOn, Schedule, WhatsApp } from '@mui/icons-material'
        ...
        <div data-title="div" id="principal" className={theme.header}>
          <Container className={theme.contenedorCertificados}>
            <div data-title="div" className={theme.divTituloCertificados}>
              ...
              <Typography variant="h1">Certificaciones Remotas</Typography>
            </div>
          </Container>

          <Container className={theme.contenedorContenidoCertificados}>
            <div data-title="div" className={theme.divContenidoCertificados}>
              <Typography variant="h2">Acerca de la Certificacion Remota</Typography>
              ...
              <NavLink to="/">
                <Button variant="text" color="primary" className={theme.buttonDosCertificados}>
                  Mas sobre la Certificación Remota
                </Button>
              </NavLink>
            </div>
          </Container>
          ...
          <Container className={theme.contenedorFirmaDigital}>
            <div data-title="div" className={theme.divFirmaDigital}>
              <div data-title="div" className={theme.divSubtitle1}>
                <Brightness1
                  color="inherit"
                  sx={{
                    fontSize: 8,
                ...
                <a target="_blank" href="/">
                  <Button variant="text" color="primary">
                    Opciones para Empresas y Particulares
                  </Button>
                </a>
              </div>
