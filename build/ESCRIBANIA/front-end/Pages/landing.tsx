...
import { ArrowCircleRightOutlined, Call, Email, Home, LocationOn, Schedule, WhatsApp } from '@mui/icons-material'
    ...
    <React.Fragment>
      <div className={theme.pages}>
          ...
          <div data-title="Div Favicon Principal" className={theme.newFavicon}>
            <NavLink to="/">
              <picture className={theme.faviconPrincipal}>
                <img src="/img/logolorem.png" alt="/img/logolorem.png" width="50" height="auto" />
              </picture>
            </NavLink>
          </div>
        ...
        <div data-title="Header" className={theme.header}>
          <Container className={theme.headerContainerCarousel} maxWidth="lg">
            <Carousel
              activeIndicatorIconButtonProps={true}
              className={theme.elementCarousel}
              height={400}
              ...
              animation="fade"
            >
              <Grid container alignItems="center" justifyContent="center" direction="column" wrap="nowrap" className={theme.gridCarouselUno}>
                <Grid item xs={12} sm={12} md={6} lg={6} className={theme.gridItemCarouselUno}>
                  <picture>
                    <img src="/img/HEADERIMAGENUNO.png" alt="/img/HEADERIMAGENUNO.png" width="1258" height="400" />
                  </picture>
                </Grid>

                <Grid item xs={12} sm={12} md={6} lg={6} className={theme.gridItemLogoUno}>
                  <NavLink to="/">
                    <picture className={theme.faviconPrincipalCarousel}>
                      <img src="/img/logolorem.png" alt="/img/logolorem.png" width="50" height="auto" />
                    </picture>
                  </NavLink>
                </Grid>

                <div data-title="div" className={theme.buttonContainerUno}>
                  <NavLink
                    to="#final"
                    onClickCapture={(e) => {
                      Final()
              ...
              <Grid container alignItems="center" justifyContent="center" direction="column" wrap="nowrap" className={theme.gridCarouselDos}>
                <Grid item xs={12} sm={12} md={6} lg={6} className={theme.gridItemCarouselDos}>
                  <picture>
                    <img src="/img/imagenheaderdos.png" alt="/img/imagenheaderdos.png" width="1258" height="400" />
                  </picture>
                </Grid>

                <Grid item xs={12} sm={12} md={6} lg={6} className={theme.gridItemTextoFotoDos}>
          ...
          <Container className={theme.containerCards}>
            <div data-title="divTarjetas" id="principal" className={theme.divTarjetas}>
              <a target="_blank" href="/firmadigital">
                <div data-title="Card" className={theme.aboutCard}>
                  <a target="_blank" href="/firmadigital">
                    <picture className={theme.img}>
                      <img src="/img/icons8-certificación-96.png" alt="/img/icons8-certificación-96.png" width="50" height="auto" />
                    </picture>
                  </a>

                  <a target="_blank" href="/firmadigital">
                    <Typography variant="h5">Certificación de la firma digital</Typography>
                  </a>
              ...
              <a target="_blank" href="/firmasolografas">
                <div data-title="Card" className={theme.aboutCard}>
                  ...
                  <a target="_blank" href="/firmasolografas">
                    <Typography variant="h5">Certificación de firmas ológrafas</Typography>
                  </a>
              ...
              <a target="_blank" href="/documentosdigitales">
                <div data-title="Card" className={theme.aboutCard}>
                  ...
                  <a target="_blank" href="/documentosdigitales">
                    <Typography variant="h5">Certificación de validez de documentos digitales</Typography>
                  </a>
            ...
            <div data-title="divTarjetas" className={theme.divTarjetas}>
              <a target="_blank" href="/certificacionesremotas">
                <div data-title="Card" className={theme.aboutCard}>
                  ...
                  <a target="_blank" href="/certificacionesremotas">
                    <Typography variant="h5">Certificaciones remotas</Typography>
                  </a>
              ...
              <a target="_blank" href="/testimoniosdigitales">
                <div data-title="Card" className={theme.aboutCard}>
                  ...
                  <a target="_blank" href="/testimoniosdigitales">
                    <Typography variant="h5">Elaboramos testimonios o copias digitales</Typography>
                  </a>
              ...
              <a target="_blank" href="/documentoselectronicos">
                <div data-title="Card" className={theme.aboutCard}>
                  ...
                  <a target="_blank" href="/documentoselectronicos">
                    <Typography variant="h5">Certificación de documentos electrónicos</Typography>
                  </a>
          ...
          <Container className={theme.contenedorTarjetasQuienesSomos}>
            <div data-title="divTarjetas" className={theme.divTarjetasQuienesSomos}>
              <div data-title="Card" className={theme.divContenidoQuienesSomos}>
                <Typography variant="h6">Experiencia</Typography>

                <Typography variant="subtitle1">
                  <span className={theme.subtitle1}>
                    Poseemos un amplio conocimiento en el campo del derecho notarial, permitiéndonos ofrecerte las soluciones que buscas.
                  </span>
                </Typography>
              </div>

              <div data-title="Card" className={theme.divContenidoQuienesSomos}>
                <Typography variant="h6">Soluciones a tus problemas</Typography>

                <Typography variant="subtitle1">
                  <span className={theme.subtitle1}>
                    Nos esforzamos por proporcionar respuestas rápidas y de calidad, siendo nuestra prioridad encontrar soluciones eficientes para
                    nuestros clientes.
                  </span>
                </Typography>
              </div>
              ...
              <div data-title="Card" className={theme.divContenidoQuienesSomos}>
                <Typography variant="h6">Asesoramiento personalizado</Typography>

                <Typography variant="subtitle1">
                  <span className={theme.subtitle1}>
                    Tu comodidad es nuestra prioridad, por eso te proporcionamos toda la información que necesitas para facilitar tus trámites y
                    negocios.
                  </span>
                </Typography>
              </div>
